...
class NorthKoreaIngestor(BaseIngestor):
    """
    North Korea-specific OSINT ingestion module.
    Expand with:
      - KPA General Staff
      - Munitions Industry Department
      - Yongbyon nuclear scientists
      - KCNA leadership announcements
    """

    def __init__(self, data_root: str = "./kpv_data"):
        super().__init__("KP", data_root)
    ...
    def fetch_raw(self) -> List[Any]:
        self.logger.info("Fetching raw OSINT data for North Korea")

        raw = [
            {
                "name_native": "박정천",
                "name_latin": "Pak Jong Chon",
                "sector": "military",
                "service_or_agency": "KPA General Staff",
                "current_position": "Vice Marshal",
                "thematic_keywords": ["artillery", "missile forces"],
            }
        ]
    ...
    def resolve_identities(
        ...
        self.logger.info("Resolving identities for North Korea")
        ...
        for item in normalized:
            ...
            if match:
                ...
                new_id = f"kp_person_{len(updated_persons) + 1}"
    ...
    def update_dataset(
        ...
        self.logger.info("Finalizing dataset update for North Korea")
        return resolved
